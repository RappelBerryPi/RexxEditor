...
public class RexxTokenList {
    ...
    public void setTokens(ColorManager manager) {
        ...
        procs     = new TextAttribute(manager.getColor(IRexxPreferenceFields.PREF_PROC_INSTR));
        methodVar = new TextAttribute(manager.getColor(IRexxPreferenceFields.PREF_VAR_COLOR), manager.getColor(IRexxColorConstants.WHITE), SWT.BOLD);
        symb      = new TextAttribute(manager.getColor(IRexxPreferenceFields.PREF_REXX_SYMBOL));
        comment   = new TextAttribute(manager.getColor(IRexxPreferenceFields.PREF_REXX_COMMENT));
        string    = new TextAttribute(manager.getColor(IRexxPreferenceFields.PREF_STRING_COLOR));
        ...
        doubleQuoteSymbol = new Token(string);
        singleQuoteSymbol = new Token(string);
